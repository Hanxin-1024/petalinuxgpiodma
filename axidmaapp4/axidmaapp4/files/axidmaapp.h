...
#define DMA_1_BASEADDR   0x40410000
#define DMA_2_BASEADDR   0x40420000
#define DMA_3_BASEADDR   0x40430000
unsigned char *map_base0;//BRAM
unsigned char *map_base1;//DMA0
unsigned char *map_base2;//DMA1
unsigned char *map_base3;//DMA2
unsigned char *map_base4;//DMA3
/**
...
*/
int axidma_config();
/*A top-level DMA sending functionUsed for JM to send data
@param[in] dev An #axidma_dev_t returned by #axidma_init.
...
/*A top-level DMA reading function.Used for JM  to read data
@param[in] dev An #axidma_dev_t returned by #axidma_init.
@param[in] trans transfer structure
...
/*A top-level DMA sending function.Used for DX to send data
@param[in] dev An #axidma_dev_t returned by #axidma_init.
@param[in] trans transfer structure
@param[in] sbuffer The data to be sent
*/
...
/*A top-level DMA reading function.Used for DX  to read data
@param[in] dev An #axidma_dev_t returned by #axidma_init.
@param[in] trans transfer structure
@param[in] rbuffer The data to be received
return  Accept the size of the data
...
/*A top-level DMA sending function.Used for DD to send data
@param[in] dev An #axidma_dev_t returned by #axidma_init.
@param[in] trans transfer structure
@param[in] sbuffer The data to be sent
*/
...
/*A top-level DMA reading function.Used for DD  to read data
@param[in] dev An #axidma_dev_t returned by #axidma_init.
@param[in] trans transfer structure
@param[in] rbuffer The data to be received
return  Accept the size of the data
...
/*A top-level DMA sending function.Used for DJ to send data
@param[in] dev An #axidma_dev_t returned by #axidma_init.
@param[in] trans transfer structure
@param[in] sbuffer The data to be sent
*/
...
/*A top-level DMA reading function.Used for DJ to read data
@param[in] dev An #axidma_dev_t returned by #axidma_init.
@param[in] trans transfer structure
@param[in] rbuffer The data to be received
return  Accept the size of the data
